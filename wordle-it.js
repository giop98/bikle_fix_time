this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    var Ra = new Date("2022-01-30T00:00:00");
    ...
    Ka.innerHTML = "\n  <style>\n  .toaster {\n    position: absolute;\n    top: 10%;\n    left: 50%;\n    transform: translate(-50%, 0);\n    pointer-events: none;\n    width: fit-content;\n  }\n  #game-toaster {\n    z-index: ".concat(1e3, ";\n  }\n  #system-toaster {\n    z-index: ").concat(4e3, ';\n  }\n\n  #game {\n    width: 100%;\n    max-width: var(--game-max-width);\n    margin: 0 auto;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n  }\n  header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-1);\n    border-bottom: 1px solid var(--color-tone-4);\n  }\n  header2 {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: var(--header-height);\n    color: var(--color-tone-1);\n    }\n header .title {\n    font-weight: 700;\n    font-size: 36px;\n    letter-spacing: 0.2rem;\n    text-transform: uppercase;\n    text-align: center;\n  }\n\n   #board-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-grow: 1;\n    overflow: hidden;\n  }\n  #board {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    grid-gap: 5px;\n    padding:10px;\n    box-sizing: border-box;\n  }\n  button.icon {\n    background: none;\n    border: none;\n    cursor: pointer;\n  }\n  #debug-tools {\n    position: absolute;\n    bottom: 0;\n  }\n\n  </style>\n  <game-theme-manager>\n    <div id="game">\n      <header>\n        <div class="menu">\n          <button id="help" class="icon">\n            <game-icon icon="help"></game-icon>\n          </button>\n        </div>\n        <div class="title">\n         BIKLE 🚲\n        </div>\n        <div class="menu">\n          <button id="settings" class="icon">\n            <game-icon icon="settings"></game-icon>\n          </button>\n        </div>\n      </header>\n   <header2>\n     <div class="title">\n         <a href="http://bidonmagazine.org/bikle/previous-solutions" style="color: blue" target="blank" title="http://bidonmagazine.org/bikle/previous-solutions">Tips and Previous Solutions</a>\n\n        </div>\n   </header2>\n    <div id="board-container">\n          <div id="board"></div>\n        </div>\n        <game-keyboard></game-keyboard>\n        <game-modal></game-modal>\n        <game-page></game-page>\n        <div class="toaster" id="game-toaster"></div>\n        <div class="toaster" id="system-toaster"></div>\n    </div>\n  </game-theme-manager>\n  <div id="debug-tools"></div>\n');
    ...
    fs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n         .end {\n    border-bottom: 1px solid var(--color-tone-4);\n } .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>BIKLE is a modified (unofficial) version of <a href="https://powerlanguage.co.uk/wordle/" style="color: blue" >WORDLE</a> and of its italian versions <a href="https://pietroppeter.github.io/wordle-it/" style="color: blue">PAROLE</a> and <a href="https://mauromunafo.github.io/" style="color: blue">KASTA</a> (of which it takes part of the code), modified for cycling fans!</p>\n  <p>The aim is very simple: find male and female <strong>cyclists</strong> whose surname is made of 5 letters. </p>\n  <p>The difficulty of the solution will vary from day to day: it can be a legend from the past, a well-known name of the present, a domestique who loves breaking away and carrying bidons.  </p>\n <p>There are 6 attempts available every day. After each attempt, the colors of the tiles will change to show you how close you are to guessing the word. More tips and all the previous solutions <a href="http://bidonmagazine.org/bikle/previous-solutions" style="color: blue" target="blank" title="http://bidonmagazine.org/bikle/previous-solutions">here</a>.</p>\n     <div class="examples">\n        <div class="example">\n       <p> <strong>Examples</strong> </p>\n    <div class="row">\n            <game-tile letter="c" evaluation="correct" reveal></game-tile>\n            <game-tile letter="o"></game-tile>\n            <game-tile letter="p"></game-tile>\n            <game-tile letter="p"></game-tile>\n            <game-tile letter="i"></game-tile>\n          </div>\n          <p>The letter <strong>C</strong> is in the word and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="b"></game-tile>\n                 <game-tile letter="r" evaluation="present" reveal></game-tile>\n       <game-tile letter="a"></game-tile>\n             <game-tile letter="n"></game-tile>\n            <game-tile letter="d"></game-tile>\n          </div>\n          <p>The letter <strong>R</strong> is in the word but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="z"></game-tile>\n            <game-tile letter="h"></game-tile>\n                     <game-tile letter="u" evaluation="absent" reveal></game-tile>\n    <game-tile letter="p"></game-tile>\n          <game-tile letter="a"></game-tile>\n         </div>\n   </div>\n     <p>The letter <strong>U</strong> is not in the word in any spot.</p>\n     </div>\n     <div class="end">  <p>Come back tomorrow, too: a new <strong>BIKLE</strong> will be available each day!</p>\n   </div>\n    <p> Created by <a href="http://bidonmagazine.org/what-is-bidon" style="color: blue"><strong>Bidon</strong></a>.</a></p>\n <p><a href="http://bidonmagazine.org/bikle-intro" style="color: blue"><strong>ISTRUZIONI IN ITALIANO</strong></a> </p>\n  </div>\n  </section>\n';
    var ks = function (e) {
        n(t, e);
        var a = h(t);
